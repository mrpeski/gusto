...
const SimpleField: React.FC<Props> = ({ label, detail, toggleShow, toggleInternalUse, toggleMandatory }) => {
  ...
  const [checkState, setCheckState] = useState<boolean>(detail.internalUse || detail.mandatory)
  ...
  const onCheckboxChange = (e: CheckboxChangeEvent) => {
    ...
    return <li className='Field-wrapper'>
      ...
      <label htmlFor="">
        <Switch checked={switchState} data-target={label} onChange={onSwitchChange}/>
