...
export const personalInfoReducer: Reducer<PersonalInfoConfig, BasicAction | QuestionAction> = (state, action) => {
...
export function toggleInternalUse(field: keyof PersonalInfoConfig): BasicAction {
    return {
        type: 'toggle',
        config: 'internalUse',
        field
